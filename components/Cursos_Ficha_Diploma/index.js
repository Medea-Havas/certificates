          ...
          <div>
            ...
            <div className={styles.diplomaContent}>
              <div className={styles.diplomaTitle}>
                <text className={typeMedium}>Diploma</text>
              </div>
              <div className={styles.diplomaDiv}>
                <div className={styles.imageDiploma}>
                  <text className={styles.typleXsmall}>
                    Imagen diploma miniatura:
                  </text>
                </div>
                <Image
                  src={'/pexels.jpeg'}
              ...
              <div className={styles.diplomaDiv}>
                <div className={styles.imageDiploma}>
                  <text className={styles.typleXsmall}>Imagen diploma 1:</text>
                </div>
                <Image
                  src={'/pexels.jpeg'}
                  alt='Picture of the author'
              ...
              <div className={styles.diplomaDiv}>
                <div className={styles.imageDiploma}>
                  <text className={styles.typleXsmall}>Imagen diploma 2:</text>
                </div>
                <Image
                  src={'/pexels.jpeg'}
                  alt='Picture of the author'
